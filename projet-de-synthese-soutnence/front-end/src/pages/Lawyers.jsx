...
function ClientRequestCard({ request, onAccept, onDecline }) {
  ...
  return (
    <div className="lawyer-card-premium animate-slide-up">
      ...
      <div className="card-footer-premium" style={{ display: 'flex', gap: '10px', marginTop: '12px', alignItems: 'center', justifyContent: 'space-between' }}>
          {request.status === 'pending' ? (
              ...
              <>
                  <span style={{ color: '#10b981', fontWeight: 'bold', padding: '8px 0' }}>
                      ✅ {t('planStatusActive') || 'مؤكد'}
                  </span>
                  <button 
                      className="decline-trash-btn" 
                      style={{ background: 'transparent', border: 'none', color: '#ef4444', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '8px' }}
                      onClick={() => onDecline(request.id)}
                      title={t('deletePost') || 'إلغاء'}
                  >
              ...
              <div class="lawyer-map-popup" dir="${direction}">
                ...
                <div class="popup-body-box">
                  ...
                  <div class="popup-actions-grid" style="grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 12px;">
                    ...
                    ` : `
                      <div style="grid-column: span 2; display: flex; align-items: center; justify-content: space-between; width: 100%; padding: 4px 0;">
                        <span style="color:#10b981; font-weight:bold; display: flex; align-items: center; gap: 4px;">✅ ${t('planStatusActive') || 'مؤكد'}</span>
                        <button class="popup-decline-btn" data-req-id="${item.id}" style="background: transparent; border: none; color: #ef4444; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 6px;" title="حذف">
